...
*/ /*
  ...
  --------------------------------------------------------------------------------------
*/
const insertEditButton = (parent, nameProduct) => {
...
const editItem = (nameProduct) => {
  ...
  for (let i = 1; i < rows.length; i++) {
    ...
    if (productNameCell.textContent === nameProduct) {
      selectedRow = rows[i];
      break;
    }
  }
  ...
  if (selectedRow) {
    // Obtenha as informações do item
    const nameProduct = selectedRow.getElementsByTagName('td')[0].textContent;
    const size = selectedRow.getElementsByTagName('td')[1].textContent;
    const quantity = selectedRow.getElementsByTagName('td')[2].textContent;

    // Preencha os campos do modal de edição com as informações do item
